...
class salesClass:
    def __init__(self,root):
        ...
        # title
        lbl_title=Label(self.root,text="View Customer Bills",font=("goudy old style",30,"bold"),bg="#184a45",fg="#fff",bd=2,relief=RIDGE).pack(side=TOP,fill=X,padx=20,pady=20)

        lbl_invoice=Label(self.root,text="Invoice No.",font=("Times new roman",15),bg="#fff").place(x=50,y=100)
        ...
        btn_search=Button(self.root,text="Search",command=self.search,font=("Times new roman",15,"bold"),bg="#2196f3",fg="#fff",cursor="hand2").place(x=360,y=100,width=120,height=28)
        ...
        self.Sales_List=Listbox(sales_Frame,font=("goudy old style",15),bg="#fff",yscrollcommand=scrolly.set)
